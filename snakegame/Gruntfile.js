...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Snakegame.st', 'src/Snakegame-Backend.st', // list all sources in dependency order
                    'src/Snakegame-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-snakegame',
